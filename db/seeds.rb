Weapon.create(name: 'ak-47', picture: 'https://csgostash.com/img/weapons/AK-47.png', category: 'rifle')
Weapon.create(name: 'm4a1-s', picture: 'https://csgostash.com/img/weapons/M4A1-S.png', category: 'rifle') 
...
Weapon.create(name: 'mag-7', picture: 'https://csgostash.com/img/weapons/MAG-7.png', category: 'heavy')
...
Skin.create(name: 'Graphite', picture: 'https://csgostash.com/img/skins/s110.png', weapon_id: 3)
Skin.create(name: 'Lightning Strike', picture: 'https://csgostash.com/img/skins/s79.png', weapon_id: 3)
Skin.create(name: 'Electric Hive', picture: 'https://csgostash.com/img/skins/s243.png', weapon_id: 3)
...
Skin.create(name: 'Fade', picture: 'https://csgostash.com/img/skins/s185.png', weapon_id: 7)
